...
$string['privacy:metadata:message_appcrue_buffered'] = 'Stores buffered push notifications to be sent or preserved upon delivery failure.';
$string['privacy:metadata:message_appcrue_buffered:body'] = 'The body text of the notification.';
$string['privacy:metadata:message_appcrue_buffered:created_at'] = 'The timestamp when the buffered message was recorded.';
$string['privacy:metadata:message_appcrue_buffered:hash'] = 'Unique hash of the message content and status.';
$string['privacy:metadata:message_appcrue_buffered:status'] = 'The transmission status of the buffered message.';
$string['privacy:metadata:message_appcrue_buffered:subject'] = 'The subject or title of the notification.';
$string['privacy:metadata:message_appcrue_buffered:url'] = 'The target link or action URL for the notification.';
$string['privacy:metadata:message_appcrue_recipients'] = 'Stores the recipient user IDs associated with buffered push notifications.';
$string['privacy:metadata:message_appcrue_recipients:message_id'] = 'The ID of the buffered notification.';
$string['privacy:metadata:message_appcrue_recipients:recipient_id'] = 'The ID of the recipient user.';
$string['privacy:metadata:twinpush'] = 'External TwinPush service used to deliver mobile push notifications to AppCrue.';
$string['privacy:metadata:twinpush:alert'] = 'The notification message body sent to the mobile device.';
$string['privacy:metadata:twinpush:device_aliases'] = 'The user identifier (such as username, national ID, or email) used to target the recipient device.';
$string['privacy:metadata:twinpush:target_id'] = 'The target deep link or URL opened when the notification is tapped.';
$string['privacy:metadata:twinpush:title'] = 'The title or subject of the notification sent to the mobile device.';
$string['privacy:subcontext'] = 'AppCrue push notifications';
